 ...
 * @author asilva
 */
public class TelaGrupoEquivalencia extends javax.swing.JFrame {
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        try {
            ...
            Logger.getLogger(TelaGrupoEquivalencia.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGrupoEquivalencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaGrupoEquivalencia().setVisible(true);
            }
        });
    }
